...
public static class UiStringsSwahili
{
    private static readonly Dictionary<string, string> NativeOverrides = new(StringComparer.Ordinal)
    {
        ...
        ["Msg_AlreadyRunning"] = "MessageFlow tayari inaendeshwa.",
        ...
        ["Status_BrowseShowingFirst"] = "Yanaonyeshwa {0} ya kwanza kati ya {1} katika {2} ms.",
        ["Sermon_BrowseCapNotice"] = "Yanaonyeshwa {0} ya kwanza kati ya {1}. Utafutaji hupata hati yoyote.",
        ["Sermon_ShowAllDocuments"] = "Onyesha zote {0}",
        ...
        ["Filter_YearLabel"] = "Mwaka:",
        ["Author_Branham"] = "Ndugu Branham",
        ["Author_Frank"] = "Ndugu Frank",
        ["Document_Open"] = "Fungua Hati",
        ["ContentType_Sermon"] = "Mahubiri",
        ["ContentType_CircularLetter"] = "Barua ya Mzunguko",
        ["ContentType_Meeting"] = "Mkutano",
        ["ContentType_Book"] = "Kitabu",
        ["Status_NoResultsInLibrary"] = "Hakuna hati za {0} zilizopatikana kwa utafutaji huu.",
        ["Font_Small"] = "Ndogo",
        ["Font_Medium"] = "Wastani",
        ["Font_Large"] = "Kubwa",
